...
describe("model: tableName", function() {
   /*
...
describe("model: usefulValues", function() {
   /*
   ...
   it("include createdAt or updatedAt when specified :", function() {
      ...
      expect(values2).to.have.all.keys("string", "updatedAt");
      expect(values2).to.not.have.all.keys("striiing", "createdAt");
   });
   ...
   it(".usefulCreateValues() include createdAt && updatedAt when specified :", function() {
      ...
      expect(values).to.exist;
      expect(values).to.be.an("object");
      expect(values).to.have.all.keys("string", "createdAt", "updatedAt");
      expect(values).to.not.have.all.keys("striiing");
   });
   ...
   it(".usefulUpdateValues() include only updatedAt :", function() {
      ...
      expect(values).to.exist;
      expect(values).to.be.an("object");
      expect(values).to.have.all.keys("string", "updatedAt");
      expect(values).to.not.have.all.keys("striiing", "createdAt");
   });
});

describe("model: .normalizeResonse() ", function() {
   /*
